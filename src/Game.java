...
public class Game {
	...
	Game() {
		...
		setActiveBoard(new Board(1)); // A Board only take player number in arguments
		setPassiveBoard(new Board(2));
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (newGame.getActiveBoard().isAlive() && newGame.getPassiveBoard().isAlive()) {
			...
			/*
			 * long startTime = System.nanoTime(); newGame.getActiveBoard().showBoard();
			 * long endTime = System.nanoTime(); System.out.println("showBoard1() : " +
			 * (endTime - startTime) + " ns"); With this test, old showBoard function took
			 * 6,663 ms to be run
			 */
			...
			/*
			 * endTime = System.nanoTime(); System.out.println("showBoard2() : " + (endTime
			 * - startTime) + " ns"); showBoard2() took 1,129 ms, saving time and ressources
			 */
			...
			newGame.switchBoard();
			// clearThat function will just skip many line to hide other player placement
			newGame.clearThat();
